  ...
  <aside>
    <div>
      ...
      <ul>
        ...
        <li>
          <router-link to="/doc/input">歌单</router-link>
        </li>
        <li>
          <router-link to="/doc/button">排行榜</router-link>
        </li>
      </ul>
    </div>
    <div>
